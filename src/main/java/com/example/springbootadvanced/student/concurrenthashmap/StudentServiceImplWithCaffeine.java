...
@Service("StudentServiceImplWithCaffeine")
public class StudentServiceImplWithCaffeine implements StudentService {
    private final StudentRepository studentRepository;
    private final Cache cache;

    @Autowired
    public StudentServiceImplWithCaffeine(StudentRepository studentRepository, CacheManager cacheManager) {
        this.studentRepository = studentRepository;
        cache = cacheManager.getCache("students");
    }
